...
public class WorldRenderer {
    ...
    public void render() {
        ...
        drawSelectionFrame();
        if (gc.isPaused()) {
            // не смог придумать, как сделать, чтобы надпись "Pause" не уползала в сторону,
            // в случае, если до ее вызова были смещения относительно мапы, (влево, вправо, вверх, вниз.. не важно..)
            font32.setColor(0.0f, 0.0f, 1f, 0.7f);
            font32.draw(batch, "Pause",0 ,500,1280, Align.center,false);
